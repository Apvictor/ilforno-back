  ...
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <?php echo form_open('restrita/estagios/cadastrar/', $atributos);
        ?>

        <div class="form-group">
          <label for="exampleTextarea1">Título</label>
          <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Digite o título" value="<?php echo set_value('titulo');?>">

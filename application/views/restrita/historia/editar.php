  ...
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <?php echo form_open('restrita/historia/editar/'.$historia->id, $atributos);
        ?>
        ...
        <div class="form-group col-md-12">
            <div id="uploaded_image_historia" class="text-danger">
              <ul style="list-style: none; display: inline-block;">
                <li>
                  <img src="<?php echo base_url('uploads/sobre/historia/'.$historia->icone);?>" width="80" class="img-thumbnail mr-1 mb-2">
                  <input type="hidden" name="icone" value="<?php echo $historia->icone; ?>">
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="number" name="ano" value="<?php echo $historia->ano;?>">
          <?php echo form_error('ano', '<div class="text-danger">', '</div>');?>
        </div>

        <div class="form-group">
          <label for="exampleTextarea1">Texto</label>
          <textarea class="form-control" id="texto" name="texto" rows="6"><?php echo $historia->texto;?></textarea>

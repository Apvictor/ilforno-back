  ...
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <?php echo form_open('restrita/obras/cadastrar_obras/', $atributos);
        ?>
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-12 col-lg-4 col-xs-4">
              <label>Caminho</label>
              <input type="text" name="caminho" placeholder="Digite o caminho" class="form-control" value="<?php echo set_value('caminho') ?>">

  ...
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <?php echo form_open('restrita/premios/editar/'.$premio->id, $atributos);
        ?>
        
        <div class="form-group">
          <label>Imagem do prêmio</label>
          <div id="fileuploader_premio">
            
          </div>
          <div id="erro_uploaded_premio" class="text-danger">

          </div>
          <?php echo form_error('icone', '<div class="text-danger">', '</div>');?>
        </div>
        <div class="form-group col-md-12">
            <div id="uploaded_image_premio" class="text-danger">
              <ul style="list-style: none; display: inline-block;">
                <li>
                  <img src="<?php echo base_url('uploads/sobre/premios/'.$premio->icone);?>" width="80" class="img-thumbnail mr-1 mb-2">
                  <input type="hidden" name="icone" value="<?php echo $premio->icone; ?>">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="titulo" name="titulo" rows="6"><?php echo $premio->titulo;?></textarea>
          <?php echo form_error('titulo', '<div class="text-danger">', '</div>');?>
        </div>

        <div class="form-group">
          <label for="exampleTextarea1">Texto</label>
          <textarea class="form-control" id="texto" name="texto" rows="6"><?php echo $premio->texto;?></textarea>
          <?php echo form_error('texto', '<div class="text-danger">', '</div>');?>
        </div>

        <button type="submit" class="btn btn-primary mr-2">Salvar</button>
        <a class="btn btn-light" href="<?php echo base_url('restrita/premios');?>">Voltar</a>
      </form>
    </div>
  </div>
</div>
